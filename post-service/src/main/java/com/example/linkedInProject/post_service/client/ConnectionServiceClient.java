...
import com.example.linkedInProject.post_service.config.AppConfig;
...
@FeignClient(name = "connection-service", path = "/connections", url = "${CONNECTION_SERVICE_URI:}" , configuration = AppConfig.class)
